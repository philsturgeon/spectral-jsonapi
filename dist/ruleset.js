...
var resourceObjectIdOptOutSchema = {
  type: "object",
...
var schemaFirstError = (...args) => {
  const result = (0, import_spectral_functions.schema)(...args);
  if (result instanceof Promise) {
    return result.then(
      (errors) => Array.isArray(errors) && errors.length > 0 ? [errors[0]] : errors
    );
  }
